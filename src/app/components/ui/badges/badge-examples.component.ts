...
@Component({
  ...
  template: `
    <div class="container mx-auto p-8 max-w-6xl">
      ...
      <!-- Variantes Básicas -->
      <section class="mb-12">
        <h2 class="text-2xl font-semibold text-gray-800 mb-6">Variantes Básicas</h2>
        ...
        <h3 class="text-lg font-medium text-gray-700 mb-4">Estilo Outline</h3>
      ...
      <!-- Formas -->
      <section class="mb-12">
        <h2 class="text-2xl font-semibold text-gray-800 mb-6">Formas</h2>
      ...
      <section class="mb-12">
        ...
        <div class="space-y-6">
          <!-- Leading Icons -->
          <div>
            <h3 class="text-lg font-medium text-gray-700 mb-4">Iconos al Inicio</h3>
            <div class="flex flex-wrap gap-3">
          ...
          <!-- Trailing Icons -->
          <div>
            <h3 class="text-lg font-medium text-gray-700 mb-4">Iconos al Final</h3>
            <div class="flex flex-wrap gap-3">
              <app-badge variant="primary" [trailingIcon]="true">
                Archivo
                <svg slot="trailing-icon" class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section class="mb-12">
        <h2 class="text-2xl font-semibold text-gray-800 mb-6">Con Indicadores de Punto</h2>

        <div class="space-y-4">
          <!-- Status Badges -->
          <div>
            <h3 class="text-lg font-medium text-gray-700 mb-4">Estados de Conexión</h3>
            <div class="flex flex-wrap gap-4">
          ...
          <!-- Activity Badges -->
          <div>
            <h3 class="text-lg font-medium text-gray-700 mb-4">Estados de Actividad</h3>
            <div class="flex flex-wrap gap-4">
      ...
      <!-- Badges Removibles -->
      <section class="mb-12">
        <h2 class="text-2xl font-semibold text-gray-800 mb-6">Badges Removibles</h2>

        <div class="space-y-6">
          <!-- Technology Tags -->
          <div>
            <h3 class="text-lg font-medium text-gray-700 mb-4">Etiquetas de Tecnología</h3>
            <div class="flex flex-wrap gap-3">
          ...
          <!-- Category Tags -->
          <div>
            <h3 class="text-lg font-medium text-gray-700 mb-4">Categorías</h3>
            <div class="flex flex-wrap gap-3">
      ...
      <!-- Badges Numéricos -->
      <section class="mb-12">
        <h2 class="text-2xl font-semibold text-gray-800 mb-6">Badges Numéricos</h2>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div class="relative p-4 bg-white rounded-lg border border-gray-200">
          ...
          <div class="relative p-4 bg-white rounded-lg border border-gray-200">
            <div class="flex items-center justify-between">
              <span class="text-sm text-gray-700">Mensajes</span>
          ...
          <div class="relative p-4 bg-white rounded-lg border border-gray-200">
            <div class="flex items-center justify-between">
              <span class="text-sm text-gray-700">Alertas</span>
      ...
      <section class="mb-12">
        ...
        <div class="space-y-4">
          <div>
            <h3 class="text-lg font-medium text-gray-700 mb-4">Badge Normal</h3>
            <app-badge variant="primary">Badge Activo</app-badge>
          </div>

          <div>
            <h3 class="text-lg font-medium text-gray-700 mb-4">Badge Deshabilitado</h3>
      ...
      <!-- Casos de Uso Reales -->
      <section class="mb-12">
        <h2 class="text-2xl font-semibold text-gray-800 mb-6">Casos de Uso Reales</h2>

        <div class="space-y-8">
          <!-- User Profile -->
          <div class="bg-white p-6 rounded-lg border border-gray-200">
            <h3 class="text-lg font-semibold mb-4">Perfil de Usuario</h3>
            <div class="flex items-center space-x-4">
              <div class="w-12 h-12 bg-emerald-green-500 rounded-full flex items-center justify-center text-white font-semibold">
                JD
              </div>
              <div class="flex-1">
          ...
          <!-- Product Card -->
          <div class="bg-white p-6 rounded-lg border border-gray-200">
            <h3 class="text-lg font-semibold mb-4">Tarjeta de Producto</h3>
            <div class="flex justify-between items-start">
              <div class="flex-1">
                <h4 class="font-medium text-gray-900 mb-2">Angular Framework</h4>
                <p class="text-gray-600 text-sm mb-3">Framework para aplicaciones web</p>
          ...
          <!-- Notification List -->
          <div class="bg-white p-6 rounded-lg border border-gray-200">
            <h3 class="text-lg font-semibold mb-4">Lista de Notificaciones</h3>
            <div class="space-y-3">
              <div class="flex items-center justify-between p-3 bg-gray-50 rounded">
                <span class="text-sm text-gray-700">Nuevo mensaje recibido</span>
              ...
              <div class="flex items-center justify-between p-3 bg-gray-50 rounded">
                <span class="text-sm text-gray-700">Tarea completada</span>
                <div class="flex gap-2">
              ...
              <div class="flex items-center justify-between p-3 bg-gray-50 rounded">
                <span class="text-sm text-gray-700">Error en el sistema</span>
                <div class="flex gap-2">
